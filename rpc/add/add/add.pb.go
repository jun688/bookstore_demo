...
var file_add_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6e, 0x67, 0x32, 0x4e,
	0x0a, 0x05, 0x61, 0x64, 0x64, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12,
	0x0c, 0x2e, 0x61, 0x64, 0x64, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e,
	0x61, 0x64, 0x64, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x03,
	0x61, 0x64, 0x64, 0x12, 0x0b, 0x2e, 0x61, 0x64, 0x64, 0x2e, 0x61, 0x64, 0x64, 0x52, 0x65, 0x71,
	0x1a, 0x0c, 0x2e, 0x61, 0x64, 0x64, 0x2e, 0x61, 0x64, 0x64, 0x52, 0x65, 0x73, 0x70, 0x62, 0x06,
...
var file_add_proto_goTypes = []interface{}{
	...
	(*Request)(nil),  // 2: add.Request
	(*Response)(nil), // 3: add.Response
}
var file_add_proto_depIdxs = []int32{
	2, // 0: add.adder.Ping:input_type -> add.Request
	0, // 1: add.adder.add:input_type -> add.addReq
	3, // 2: add.adder.Ping:output_type -> add.Response
	1, // 3: add.adder.add:output_type -> add.addResp
...
func (c *adderClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/add.adder/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
