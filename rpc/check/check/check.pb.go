...
var file_check_proto_rawDesc = []byte{
	...
	,
}
...
var file_check_proto_goTypes = []interface{}{
	...
	(*CheckReq)(nil),  // 2: check.checkReq
	(*CheckResp)(nil), // 3: check.checkResp
}
var file_check_proto_depIdxs = []int32{
	0, // 0: check.checker.Ping:input_type -> check.Request
	2, // 1: check.checker.check:input_type -> check.checkReq
	1, // 2: check.checker.Ping:output_type -> check.Response
	3, // 3: check.checker.check:output_type -> check.checkResp
...
func (c *checkerClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/check.checker/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCheckerServer) Ping(context.Context, *Request) (*Response, error) {
...
func _Checker_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/check.checker/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckerServer).Ping(ctx, req.(*Request))
	}
